...
namespace RubyPInvoke
{
   ...
   public unsafe class RubyWrapper
   {
      ...
      const string RUBY_DLL = "msvcrt-ruby210";
      ...
      // Return:  VALUE
      [DllImport(RUBY_DLL)]
      public static extern IntPtr rb_funcallv(IntPtr value0, IntPtr id1, int integer2, IntPtr value3);

      // VALUE rb_funcallv_public(VALUE, ID, int, const VALUE*)
      // Name:    rb_funcallv_public
      // Params:  (VALUE, ID, int, const VALUE*)
      // Return:  VALUE
      [DllImport(RUBY_DLL)]
      public static extern IntPtr rb_funcallv_public(IntPtr value0, IntPtr id1, int integer2, IntPtr value3);
      ...
      // Name:    rb_ary_new_capa
      // Params:  (long capa)
      // Return:  VALUE
      [DllImport(RUBY_DLL)]
      public static extern IntPtr rb_ary_new_capa(long longInteger0);

      // VALUE rb_ary_new_from_args(long n, ...)
      // Name:    rb_ary_new_from_args
      // Params:  (long n, ...)
      // Return:  VALUE
      [DllImport(RUBY_DLL)]
      public static extern IntPtr rb_ary_new_from_args(long longInteger0, object varargs);

      // VALUE rb_ary_new_from_values(long n, const VALUE *elts)
      // Name:    rb_ary_new_from_values
      // Params:  (long n, const VALUE *elts)
      // Return:  VALUE
      [DllImport(RUBY_DLL)]
      public static extern IntPtr rb_ary_new_from_values(long longInteger0, IntPtr value1);
      ...
      // Name:    rb_ary_cat
      // Params:  (VALUE, const VALUE *, long)
      // Return:  VALUE
      [DllImport(RUBY_DLL)]
      public static extern IntPtr rb_ary_cat(IntPtr value0, IntPtr value1, long longInteger2);
